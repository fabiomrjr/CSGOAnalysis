...
class GameBuilder():
    ...
    def createGame(self, game_info_array, picks_remove_info_array, maps_ct_tr_info_array, frames, team_rank_array, rounds_detail_informations):
        ...
        if game == None:
            if team1_score > team2_score:
                game = GameDAO().createGame(championship.id_championship, team1.id_team, team2.id_team, game_datetime, team1_score, team2_score, team1.id_team, best_of,
                                            team1_pick, team2_pick, team1_removes, team2_removes, team1_rank, team2_rank)
            elif team1_score < team2_score:
                game = GameDAO().createGame(championship.id_championship, team1.id_team, team2.id_team, game_datetime, team1_score, team2_score, team2.id_team, best_of,
                                            team1_pick, team2_pick, team1_removes, team2_removes, team1_rank, team2_rank)
            else:
                game = GameDAO().createGame(championship.id_championship, team1.id_team, team2.id_team, game_datetime, team1_score, team2_score, None, best_of,
                                            team1_pick, team2_pick, team1_removes, team2_removes, team1_rank, team2_rank)
        else:
            if team1_score > team2_score:
                GameDAO().updateGame(game, championship.id_championship, team1.id_team, team2.id_team, game_datetime, team1_score, team2_score, team1.id_team, best_of,
                                            team1_pick, team2_pick, team1_removes, team2_removes, team1_rank, team2_rank)
            elif team1_score < team2_score:
                GameDAO().updateGame(game, championship.id_championship, team1.id_team, team2.id_team, game_datetime, team1_score, team2_score, team2.id_team, best_of,
                                            team1_pick, team2_pick, team1_removes, team2_removes, team1_rank, team2_rank)
            else:
                GameDAO().updateGame(game, championship.id_championship, team1.id_team, team2.id_team, game_datetime, team1_score, team2_score, None, best_of,
                                            team1_pick, team2_pick, team1_removes, team2_removes, team1_rank, team2_rank)

        maps_array = self.createMap(game, maps_ct_tr_info_array, rounds_detail_informations, best_of)
        self.createPlayerMapStats(maps_array, team1, team2, frames)

    def createMap(self, game, maps_ct_tr_info_array, rounds_detail_informations, best_of):
        mapList = []
        maps = ""
        ...
        for aux in range(0, len(rounds_detail_informations)):
            ...
            while aux2 < 10:
                ...
                if attrsLen != 0 and attrsclas != 0 and (rounds_detail_informations[aux].contents[aux2].attrs['class'][0] == "ct" or rounds_detail_informations[aux].contents[aux2].attrs['class'][0] == "t"):
            ...
            if createdMap == None:
                createdMap = MapDAO().createMap(game.id_game, map_name, team1_tr_rounds, team2_tr_rounds, team1_ct_rounds, team2_ct_rounds, overtime_team1_rounds, overtime_team2_rounds, team1_score, team2_score)
    ...
    def createPlayerMapStats(self, maps_array, team1, team2, frames):
        ...
        for count in range(0, len(maps_array)):
            ...
            for counter in range(1,6):
                ...
                PlayerMapStatsDAO().createPlayerMapStats(team1.id_team, actual_map.id_map_game, player.id_player, kills, deaths, plus_minos, adr, kast, rating2)
                ...
                player = PlayerBuilder().createPastPlayer(team1, nick, player_name)
                PlayerMapStats = PlayerMapStatsDAO().getPlayerMapStatsByPlayerTeamAndMap(team2.id_team, actual_map.id_map_game, player.id_player)
                if PlayerMapStats == None:
                    PlayerMapStatsDAO().createPlayerMapStats(team2.id_team, actual_map.id_map_game, player.id_player, kills, deaths, plus_minos, adr, kast, rating2)
